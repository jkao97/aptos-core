...
use aptos_types::{
    ...
    transaction::{
        ...
        BlockOutput, FeeDistribution, Transaction,
    },
    ...
    A: AuxiliaryInfoTrait,
{
    ...
    fn execute_v2(
        ...
        let execution_result =
            executor.execute_transaction(&sync_view, txn, idx_to_execute, auxiliary_info);
                ...
                if !has_reconfig {
                        ...
                        transaction_slice_metadata.append_state_checkpoint_to_block()
                    {
                        ...
                        if Self::execute(
                            ...
                            // Question[MI Counter]: The AuxInfo for the above block epilogue txn isn't set in the block preparer. So, setting u32::MAX as transaction index here. Is that okay?
                            &A::new_max(),
                            last_input_output,
                            versioned_cache,
                            &executor,
    ...
    pub(crate) fn execute_transactions_sequential(
        ...
        while idx <= num_txns {
            ...
            let res =
                executor.execute_transaction(&latest_view, txn, idx as TxnIndex, auxiliary_info);
