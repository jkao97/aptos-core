...
pub const DEFAULT_FORGE_DEPLOYER_IMAGE_TAG: &str = "cacf3cf0f5c4be658df8d25f8094ecf70e16dabe"; // default to the latest stable build from the main branch (2025-07-26)
